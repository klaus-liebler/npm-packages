...
import { Uint8x32 } from '../fingerprint/uint8x32';
...
librarySizeUsed():number {
  const offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? this.bb!.readUint16(this.bb_pos + offset) : 0;
}

libraryUsedIndices(obj?:Uint8x32):Uint8x32|null {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? (obj || new Uint8x32()).__init(this.bb_pos + offset, this.bb!) : null;
}
...
static addLibrarySizeMax(builder:flatbuffers.Builder, librarySizeMax:number) {
  builder.addFieldInt16(1, librarySizeMax, 0);
}

static addLibrarySizeUsed(builder:flatbuffers.Builder, librarySizeUsed:number) {
  builder.addFieldInt16(2, librarySizeUsed, 0);
}

static addLibraryUsedIndices(builder:flatbuffers.Builder, libraryUsedIndicesOffset:flatbuffers.Offset) {
  builder.addFieldStruct(3, libraryUsedIndicesOffset, 0);
}

static addSecurityLevel(builder:flatbuffers.Builder, securityLevel:number) {
  builder.addFieldInt8(4, securityLevel, 0);
}

static addDeviceAddress(builder:flatbuffers.Builder, deviceAddress:number) {
  builder.addFieldInt32(5, deviceAddress, 0);
}

static addDataPacketSizeCode(builder:flatbuffers.Builder, dataPacketSizeCode:number) {
  builder.addFieldInt8(6, dataPacketSizeCode, 0);
}

static addBaudRateTimes9600(builder:flatbuffers.Builder, baudRateTimes9600:number) {
  builder.addFieldInt8(7, baudRateTimes9600, 0);
}

static addAlgVer(builder:flatbuffers.Builder, algVerOffset:flatbuffers.Offset) {
  builder.addFieldOffset(8, algVerOffset, 0);
}

static addFwVer(builder:flatbuffers.Builder, fwVerOffset:flatbuffers.Offset) {
  builder.addFieldOffset(9, fwVerOffset, 0);
}
