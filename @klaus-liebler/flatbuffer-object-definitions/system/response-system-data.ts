...
static addSecondsEpoch(builder:flatbuffers.Builder, secondsEpoch:bigint) {
  builder.addFieldInt64(0, secondsEpoch, BigInt('0'));
}

static addSecondsUptime(builder:flatbuffers.Builder, secondsUptime:bigint) {
  builder.addFieldInt64(1, secondsUptime, BigInt('0'));
}
