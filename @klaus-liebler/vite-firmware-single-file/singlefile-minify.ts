...
// Bundle (s. vite-plugin-single-file-firmware-asset.ts). Vorher als textidentische Kopie in
// factory_in_a_box/web/build-tools/singlefile-minify.ts UND
// sensact_firmware/web/singlefile-minify.ts gepflegt -- jetzt hier EIN Mal, von beiden (plus
// labathome) per file:-Abhaengigkeit auf @klaus-liebler/vite-firmware-single-file konsumiert.
//
