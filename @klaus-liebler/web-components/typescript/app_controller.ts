...
export class AppController implements IAppManagement, IScreenControllerHost {
  ...
  constructor(private readonly appTitle:string, private readonly websocketUrl:string, private readonly activateChatbot=false, private readonly activateEastereggs=false, private readonly specificWarning:string=""){}
